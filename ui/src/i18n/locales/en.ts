...
export const en: TranslationMap & {
  ...
  githubPreview: {
    ...
    unavailableNextStep: "Previews are available for public repositories only.",
    rateLimited: "GitHub API rate limit reached",
    rateLimitedNextStep:
      "Try again later. For recurring limits, ask the Gateway administrator to check gateway.controlUi.github.token.",
